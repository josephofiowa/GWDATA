# thanks to K Markham for his expertise and resources
...
drinks = pd.read_table('https://raw.githubusercontent.com/josephofiowa/DAT8/master/data/drinks.csv', sep=',')
...
ufo = pd.read_table('https://raw.githubusercontent.com/justmarkham/DAT8/master/data/ufo.csv', sep=',')
